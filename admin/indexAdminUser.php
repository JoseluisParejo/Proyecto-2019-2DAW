...
<body>
  ...
  <!-- END NAV -->
  <!-- TABLA INSERTAR USER -->
  <!-- Esta es la pequeña tabla que inserta el usuario que rellenes -->
          ...
          <div class="row align-items-center">  
            <div class="col-md4">
              <div class="card card-body">
                <form action="indexAdminGuardarUser.php" method="POST">
                  <div class="form-group">
                    <input type="text" name="newmail" class="form-control" placeholder="Correo" autofocus>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <input type="password" name="newpasswd" class="form-control" placeholder="Password">
                  </div>
                  <div class="form-group">
									<input type="radio" name="tipoUser" value="0"><label>Usuario</label><br>
									<input type="radio" name="tipoUser" value="1"><label>Administrador</label>
								</div>
                  <input type="submit" class="btn-success btn-block" name="guardar_Usuario" value="Guardar User">
                </form>
              </div>
            </div>
            <!-- En esta tabla mostraremos todos los usuarios para modificarlos o borrarlos -->
            <div class="col-md-8">
              <table class="table table-bordered" id="tabla-color">
                ...
                <?php
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="indexAdminEditUser.php?correo=<?php echo $row['correo']?>" class="btn-secondary">
                        <i class="fas fa-marker"></i>
                      </a><br>
                      <a href="indexAdminBorrarUser.php?correo=<?php echo $row['correo']?>" class="btn-danger">
