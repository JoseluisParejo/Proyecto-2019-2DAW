...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="indexUser.php">Hotel Sol Y Mar</a>
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item active"><a href="indexUser.php" class="nav-link">Home</a></li>
  ...
  <div class="block-31" style="position: relative;">
    <div class="owl-carousel loop-block-31 ">
      ...
      <div class="block-30 item" style="background-image: url('images/bg_7.jpg');" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-10">
              <span class="subheading-sm">Bienvenido</span>
              <h2 class="heading">Accede a tu cuenta y personalizala</h2>
              <p><a href="cuenta.php" class="btn py-4 px-5 btn-primary">Mi cuenta</a></p>
            </div>
          </div>
        </div>
      </div>
