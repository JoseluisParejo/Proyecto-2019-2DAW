...
$mail->Subject = 'Informacion de la cancelación'; //titulo del correo
$mail->Body = "Su reserva a sido cancelada"; //contenido del correo
//este condicional mostrara un mensaje si el correo se envia o no
if(!$mail->Send()) {
